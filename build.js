...
const PAGES = [
  ...
  { key:'single-stakes-about', file:'single-stakes-about.html', title:'Single Stakes About (SSA) Calculator — Up & Down Bet | BetCalc UK', metaDesc:'Free Single Stakes About calculator. Also called Up-and-Down. 2 selections, 2 bets.', h1:'Single Stakes About (Up &amp; Down) Bet Calculator', intro:'The SSA is a 2-bet wager where winnings from selection A roll to selection B, and vice versa.', what:'<p>A <strong>Single Stakes About</strong>: Bet 1 stakes on A, if A wins the return goes on B. Bet 2 stakes on B, if B wins the return goes on A. 2 bets total.</p>', formula:'If A wins: return from A placed on B\nIf B wins: return from B placed on A\nIf both win: full compound return on both legs', selections:2, bets:2, betType:'single-stakes-about' },
  { key:'double-stakes-about', file:'double-stakes-about.html', title:'Double Stakes About (DSA) Calculator | BetCalc UK', metaDesc:'Free Double Stakes About calculator. Like SSA but double stake. 2 selections, 2 bets.', h1:'Double Stakes About (DSA) Bet Calculator', intro:'The DSA works like a Single Stakes About but with double the stake investment on each direction.', what:'<p>A <strong>Double Stakes About</strong> is an SSA with doubled stake on each direction — amplifying compound returns when both win.</p>', formula:'DSA = 2 × SSA stake on each direction\n2 bets total', selections:2, bets:2, betType:'double-stakes-about' },
  { key:'round-robin', file:'round-robin.html', title:'Round Robin Bet Calculator — 3 Selections, 10 Bets | BetCalc UK', metaDesc:'Free Round Robin calculator. 3 doubles, 1 treble, 3 SSA pairs = 10 bets.', h1:'Round Robin Bet Calculator', intro:'A Round Robin covers 3 selections with 10 bets: 3 doubles, 1 treble, and 3 SSA (Up-and-Down) pairs.', what:'<p>A <strong>Round Robin</strong>: <strong>3 doubles</strong>, <strong>1 treble</strong>, <strong>3 SSA pairs</strong> — 10 bets total.</p>', formula:'3 doubles + 1 treble + 3 SSA pairs = 10 bets\n£1 Round Robin costs £10', selections:3, bets:10, betType:'round-robin' },
  { key:'flag', file:'flag.html', title:'Flag Bet Calculator — 4 Selections, 23 Bets | BetCalc UK', metaDesc:'Free Flag bet calculator. 6 doubles, 4 trebles, 1 four-fold, 6 SSA pairs = 23 bets.', h1:'Flag Bet Calculator', intro:'A Flag covers 4 selections with 23 bets — Yankee combinations plus 6 SSA pairs for extra return potential.', what:'<p>A <strong>Flag</strong>: <strong>6 doubles</strong>, <strong>4 trebles</strong>, <strong>1 four-fold</strong>, <strong>6 SSA pairs</strong> — 23 bets.</p>', formula:'6+4+1 (Yankee) + 6 SSA pairs = 23 bets\n£1 Flag costs £23', selections:4, bets:23, betType:'flag' },
  { key:'super-flag', file:'super-flag.html', title:'Super Flag Bet Calculator — 5 Selections, 46 Bets | BetCalc UK', metaDesc:'Free Super Flag calculator. Canadian bets plus SSA pairs = 46 bets.', h1:'Super Flag Bet Calculator', intro:'A Super Flag extends the Canadian with SSA pairs across 5 selections — 46 bets total.', what:'<p>A <strong>Super Flag</strong>: Canadian (26 bets) + 10 SSA pairs (20 extra bets) = 46 bets total.</p>', formula:'Canadian(26) + 10 SSA pairs(20) = 46 bets\n£1 Super Flag costs £46', selections:5, bets:46, betType:'super-flag' },
  { key:'heinz-flag', file:'heinz-flag.html', title:'Heinz Flag Bet Calculator — 6 Selections, 87 Bets | BetCalc UK', metaDesc:'Free Heinz Flag calculator. Heinz plus SSA pairs = 87 bets across 6 selections.', h1:'Heinz Flag Bet Calculator', intro:'A Heinz Flag extends the Heinz with SSA pairs — 87 bets across 6 selections.', what:'<p>A <strong>Heinz Flag</strong>: Heinz (57 bets) + 15 SSA pairs (30 bets) = 87 bets.</p>', formula:'Heinz(57) + 15 SSA pairs(30) = 87 bets\n£1 Heinz Flag costs £87', selections:6, bets:87, betType:'heinz-flag' },
  { key:'super-heinz-flag', file:'super-heinz-flag.html', title:'Super Heinz Flag Calculator — 7 Selections, 162 Bets | BetCalc UK', metaDesc:'Free Super Heinz Flag calculator. 162 bets across 7 selections.', h1:'Super Heinz Flag Bet Calculator', intro:'The Super Heinz Flag extends the Super Heinz with SSA pairs — 162 bets across 7 selections.', what:'<p>A <strong>Super Heinz Flag</strong>: Super Heinz (120) + 21 SSA pairs (42) = 162 bets.</p>', formula:'Super Heinz(120) + 21 SSA pairs(42) = 162 bets\n£1 Super Heinz Flag costs £162', selections:7, bets:162, betType:'super-heinz-flag' },
  { key:'goliath-flag', file:'goliath-flag.html', title:'Goliath Flag Bet Calculator — 8 Selections, 303 Bets | BetCalc UK', metaDesc:'Free Goliath Flag calculator. 303 bets — the largest flag bet. 8 selections.', h1:'Goliath Flag Bet Calculator', intro:'The Goliath Flag is the largest standard flag bet — 303 bets across 8 selections.', what:'<p>A <strong>Goliath Flag</strong>: Goliath (247) + 28 SSA pairs (56) = 303 bets.</p>', formula:'Goliath(247) + 28 SSA pairs(56) = 303 bets\n£1 Goliath Flag costs £303', selections:8, bets:303, betType:'goliath-flag' },
  { key:'union-jack-trebles', file:'union-jack-trebles.html', title:'Union Jack Trebles Calculator — 9 Selections, 8 Bets | BetCalc UK', metaDesc:'Free Union Jack Trebles calculator. 8 trebles from a 3x3 grid pattern.', h1:'Union Jack Trebles Bet Calculator', intro:'The Union Jack Trebles uses a 3×3 grid of 9 selections to form 8 trebles along the rows, columns and diagonals.', what:'<p>A <strong>Union Jack Trebles</strong>: 8 trebles along the rows, columns and diagonals of a 3×3 grid of 9 selections.</p>', formula:'Grid: 1|2|3 / 4|5|6 / 7|8|9\nRows:(1,2,3)(4,5,6)(7,8,9)\nColumns:(1,4,7)(2,5,8)(3,6,9)\nDiagonals:(1,5,9)(3,5,7)\nTotal = 8 trebles', selections:9, bets:8, betType:'union-jack-trebles' },
  { key:'union-jack-trixie', file:'union-jack-trixie.html', title:'Union Jack Trixie Calculator — 9 Selections, 32 Bets | BetCalc UK', metaDesc:'Free Union Jack Trixie calculator. 8 trebles + 24 doubles = 32 bets.', h1:'Union Jack Trixie Bet Calculator', intro:'The Union Jack Trixie adds all unique doubles from the 8 treble lines — 32 bets total.', what:'<p>A <strong>Union Jack Trixie</strong>: 8 trebles + 24 doubles = 32 bets.</p>', formula:'8 trebles + 24 doubles = 32 bets\n£1 Union Jack Trixie costs £32', selections:9, bets:32, betType:'union-jack-trixie' },
  { key:'union-jack-patent', file:'union-jack-patent.html', title:'Union Jack Patent Calculator — 9 Selections, 56 Bets | BetCalc UK', metaDesc:'Free Union Jack Patent calculator. 8 trebles, 24 doubles, 24 singles = 56 bets.', h1:'Union Jack Patent Bet Calculator', intro:'The Union Jack Patent adds singles to the doubles and trebles — 56 bets with a return from just one winner.', what:'<p>A <strong>Union Jack Patent</strong>: 8 trebles + 24 doubles + 24 singles = 56 bets.</p>', formula:'8 trebles + 24 doubles + 24 singles = 56 bets\n£1 Union Jack Patent costs £56', selections:9, bets:56, betType:'union-jack-patent' },
  { key:'union-jack-round-robin', file:'union-jack-round-robin.html', title:'Union Jack Round Robin Calculator — 9 Selections, 80 Bets | BetCalc UK', metaDesc:'Free Union Jack Round Robin calculator. 8 trebles, 24 doubles and SSA pairs = 80 bets.', h1:'Union Jack Round Robin Bet Calculator', intro:'The Union Jack Round Robin adds SSA pairs to the doubles and trebles from the Union Jack grid — 80 bets total.', what:'<p>A <strong>Union Jack Round Robin</strong>: 8 trebles + 24 doubles + 24 SSA pairs (48 bets) = 80 bets.</p>', formula:'8 trebles + 24 doubles + 24 SSA pairs = 80 bets\n£1 Union Jack Round Robin costs £80', selections:9, bets:80, betType:'union-jack-round-robin' },
  { key:'parlay', file:'parlay.html', title:'Parlay Bet Calculator — Multi-Selection Returns | BetCalc UK', metaDesc:"Free Parlay calculator. The American accumulator — all selections must win. Supports 2 to 20 legs.", h1:'Parlay Bet Calculator', intro:"A Parlay is the American term for an accumulator — all selections must win for a return. Massive potential returns from small stakes.", what:'<p>A <strong>Parlay</strong> is mathematically identical to an accumulator. All selections must win, with each winner\'s return rolling to the next leg.</p>', formula:'Return = Stake × (Odds_1 × Odds_2 × ... × Odds_n)\nSame as an Accumulator', selections:4, bets:1, betType:'parlay' },
];
...
<body class="page-wrapper" data-bet-type="${p.betType}">

  <header class="site-header">
    <div class="header-inner">
      <a href="../index.html" class="site-logo" aria-label="BetCalc UK home">
  ...
  <main>
    <div class="container page-content">
        ...
        <div class="card-body" id="calc-form">
          ...
          <div class="stake-section">
            <div class="bet-count-row">
              ...
              <span id="ew-badge" class="ew-badge" style="display:none">Each Way ×2</span>
            </div>
            <div class="stake-row">
      ...
      <section class="bookmakers-section section-block" aria-label="Top bookmakers">
        ...
        <p class="section-intro">Compare welcome offers from the UK's top bookmakers. New customers only. T&amp;Cs apply. 18+</p>
      ...
      <section class="content-section section-block">
        ...
        <div class="bet-types-grid">
          ...
          <a href="../index.html" class="bet-type-link" style="grid-column:span 2">View All Calculators &rarr;</a>
        </div>
      </section>
    ...
    <div class="container">
      ...
      <div class="footer-grid">
        <div class="footer-brand">
          <div class="logo-text">Bet<span style="color:var(--accent)">Calc</span> UK</div>
          <p>Free bet calculator for UK punters. Calculate returns for all major bet types instantly.</p>
        </div>
        <div class="footer-col">
          <h4>Calculators</h4>
          <ul>
            <li><a href="lucky-15.html">Lucky 15</a></li>
            <li><a href="lucky-31.html">Lucky 31</a></li>
            <li><a href="yankee.html">Yankee</a></li>
            <li><a href="accumulator.html">Accumulator</a></li>
        ...
        <div class="footer-col">
          <h4>Guides</h4>
          <ul>
            <li><a href="../guides/what-is-a-lucky-15.html">What is a Lucky 15?</a></li>
            <li><a href="../guides/what-is-a-yankee.html">What is a Yankee?</a></li>
            <li><a href="../guides/what-is-an-accumulator.html">What is an Accumulator?</a></li>
            <li><a href="../guides/each-way-betting-explained.html">Each Way Explained</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h4>Information</h4>
          <ul>
            <li><a href="../bookmakers.html">Best Bookmakers</a></li>
      ...
      <div class="footer-bottom">
        ...
        <span>This site contains commercial content. <a href="../about.html#disclaimer">Disclaimer</a></span>
      </div>
    </div>
  </footer>
  ...
  <script>
    const BOOKMAKERS = [
      { id:'bet365', name:'bet365', rating:5, offer:'Bet £10 Get £30 in Free Bets', lucky15:'Standard Lucky 15 terms', link:'#bet365', terms:'New customers. T&C apply. 18+' },
      { id:'betfred', name:'Betfred', rating:5, offer:'£30 Free Bets + Bonuses', lucky15:'<strong>Double odds</strong> on 1 winner, <strong>10% bonus</strong> all winners', link:'#betfred', terms:'New customers only. T&C apply. 18+' },
      { id:'paddypower', name:'Paddy Power', rating:4, offer:'Bet £20 Get £20 Free', lucky15:'<strong>Treble odds</strong> on a single winner', link:'#paddypower', terms:'New customers. T&C apply. 18+' },
      { id:'coral', name:'Coral', rating:4, offer:'Bet £5 Get £20', lucky15:'<strong>Double odds</strong> on 1 winner, <strong>10% bonus</strong> all winners', link:'#coral', terms:'New customers. T&C apply. 18+' },
    ];
...
for (const p of PAGES) {
  ...
  console.log(`Generated: calculators/${p.file}`);
  count++;
}
console.log(`\nAll ${count} calculator pages generated!`);
